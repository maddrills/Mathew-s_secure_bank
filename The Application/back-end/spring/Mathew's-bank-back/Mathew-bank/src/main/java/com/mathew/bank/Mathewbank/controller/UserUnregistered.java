...
public class UserUnregistered {
    ...
    public boolean registerUser(@RequestBody UserApplicationDTO userApplicationDTO, HttpServletResponse response){

        System.out.println(userApplicationDTO.toString());
